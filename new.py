#!/usr/bin/env python3
"""
Author : Dario Nieva <darionieva.dev@gmail.com>
Purpose: Python program to write a Python program
Disclaimer: This program is based on Ken Youens-Clark's book
"""
...
def get_args() -> Args:
    ...
    parser = argparse.ArgumentParser(
        description='Create a Python program with argparse data',
...
def get_args():
    ...
    parser.add_argument('-a', '--arg', help='A named string argument', metavar='str', type=str, default='')
    parser.add_argument('-i', '--int', help='A named integer argument', metavar='int', type=int, default=0)
    parser.add_argument('-f', '--file', help='A readable file', metavar='FILE', type=argparse.FileType('rt'), default=None)
